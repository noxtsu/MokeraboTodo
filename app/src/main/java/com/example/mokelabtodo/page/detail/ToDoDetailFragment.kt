package com.example.mokelabtodo.page.detail
...
import com.example.mokelabtodo.R
import com.example.mokelabtodo.databinding.TodoDetailFragmentBinding
...
class ToDoDetailFragment: Fragment(R.layout.todo_detail_fragment){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vm.todo.observe(viewLifecycleOwner) { todo ->
            binding.tltleText.text = todo.title
